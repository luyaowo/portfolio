...
![Material You 单复选封面](cover.webp)

Radio 翻译为收音机,Switch 为开关。

![Radio/Checkbox/Switch 总览](radio-overview.webp)
...
![定义](radio-definition.webp)

![定义示例](radio-definition-2.webp)

## 2. 注意事项

- 当选项较少时可以采用单选,当选项较多且空间少的时候,可以采用底部浮层样式

![底部浮层样式](radio-note-1.webp)

- 当选项较多且空间充裕时,可以用选择胶囊替代单/复选框

![选择胶囊替代](radio-note-2.webp)

## 3. 样式

![样式](radio-styles.webp)

## 4. 参考

![单选/多选案例](radio-reference-1.webp)

有很多 App 采用此样式作为多选,虽然并非人们习惯的语意样式,但是一般此场景多用于照片选择、删除、新增等

![单复选组件扩展](radio-reference-2.webp)
